...
try {
    ...
    window.dt_responsive = require('datatables.net-responsive-dt');
    window.jquery_mask = require('jquery-mask-plugin');
    window.Swal = require('sweetalert2');
    window.bsCustomFileInput = require('bs-custom-file-input');
    window.Select2 = require('select2');
    window.Daterangepicker = require('daterangepicker');
    window.maximizeSelect2Height = require('maximize-select2-height');
