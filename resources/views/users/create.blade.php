        ...
        <div class="col-md-8">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-light">
                    ...
                    <li class="breadcrumb-item"><a class="text-dark" href="{{route('users.index')}}">Criar Usuário</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Novo Usuário</li>
                </ol>
            </nav>

            <div class="card shadow-sm">
                <h4 class="card-header text-center">{{ __('Novo Usuário') }}</h4>
                ...
                <form method="POST" action="{{ route('users.store') }}">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="firstname" type="text" class="form-control @error('firstname') is-invalid @enderror" name="firstname" value="{{ old('firstname') }}" placeholder="Digite o nome do usuário..." autocomplete="firstname" maxlength="20" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="lastname" type="text" class="form-control @error('lastname') is-invalid @enderror" name="lastname" value="{{ old('lastname') }}" placeholder="Digite o sobrenome do usuário..." autocomplete="lastname" maxlength="20" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" placeholder="Digite o usuário..." autocomplete="username" maxlength="50" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="cpf" type="text" class="form-control @error('cpf') is-invalid @enderror" name="cpf" value="{{ old('cpf') }}" placeholder="XXX.XXX.XXX-XX" autocomplete="cpf" maxlength="20" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" placeholder="(XX) XXXXX-XXXX" autocomplete="phone" maxlength="20" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Email@exemplo.com.br" autocomplete="email" maxlength="50" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="password" type="text" class="form-control @error('password') is-invalid @enderror" name="password" value="{{ old('password') }}" placeholder="Digite a senha do usuário..." autocomplete="password" maxlength="50" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="Confirme a senha do usuário..." autocomplete="new-password">
                            </div>
                        </div>
